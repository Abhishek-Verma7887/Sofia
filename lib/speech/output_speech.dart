...
final String exploreTracksCompletion = 'You can explore more tracks on the next page';
...
final String oneCompletion = 'You have received 10 stars, for completing one out of seven poses of the beginners track.';

final String oneCompletionString = 'You have received ⭐10, for completing 1/7 poses of the Beginners track.';